...
use Lidl\MyBundle\Entity\Task;
use Lidl\MyBundle\Form\TaskType;
...
class TaskController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('LidlMyBundle:Task')->findAll();
     ...
     * @Method("POST")
     * @Template("LidlMyBundle:Task:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('LidlMyBundle:Task')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("LidlMyBundle:Task:edit.html.twig")
     */
